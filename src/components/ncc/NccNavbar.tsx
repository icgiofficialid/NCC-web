// ================================================================
// NccNavbar.tsx — Warm cultural aesthetic · amber/rose accent
// ================================================================
  ...
  return (
    <motion.nav
      ...
      className={cn(
        ...
        scrolled
          ? "border-b border-border/80 bg-background/92 backdrop-blur-2xl shadow-[0_1px_0_hsl(32_100%_55%/0.08)]"
          ...
          <motion.div className="relative shrink-0" whileHover={{ scale: 1.08 }} transition={{ duration: 0.2 }}>
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 16px hsl(32 100% 55% / 0.35)",
                color: "#fff",
              }}
            >
              <BatikMark size={20} />
        ...
        >
          ...
          <NavLink
            ...
            style={{
              background: "linear-gradient(135deg, hsl(32 100% 48%), hsl(350 90% 50%))",
              color: "#fff",
              boxShadow: "0 2px 16px hsl(32 100% 55% / 0.3)",
            }}
          >
            <BatikMark size={13} />
            Register
