...
import IccShell from "@/components/ncc/NccShell";
import SectionReveal from "@/components/ncc/SectionReveal";
import { useLang } from "@/components/LanguageProvider";
import { useEvent } from "@/hooks/useEvents";
import {
  competitionCategories, divisions, nccJudgingCriteria,
      ...
      {isIcc && (
        <section className="container py-20">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              { key: "dance",   label: LABELS.judgingDance,   criteria: nccJudgingCriteria.dance,   icon: "💃", color: accentColor2 },
              { key: "costume", label: LABELS.judgingCostume, criteria: nccJudgingCriteria.costume, icon: "👘", color: "hsl(270 70% 60%)" },
              { key: "vocal",   label: LABELS.judgingVocal,   criteria: nccJudgingCriteria.vocal,   icon: "🎤", color: "hsl(175 70% 45%)" },
