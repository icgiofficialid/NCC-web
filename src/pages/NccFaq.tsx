...
import { faqItems, NCC_ACCENT, NCC_DIM } from "@/components/ncc/NccData";
          ...
          >
            <div className="relative max-w-3xl space-y-5">
              ...
              <p className="max-w-xl leading-8 text-muted-foreground">
                {lang === "en"
                  ? "Everything you need to know about participating in NCC — the National Cultural Competition."
                  : "Semua yang perlu Anda ketahui tentang berpartisipasi dalam NCC — National Cultural Competition."}
              </p>
            </div>
          </div>
        </SectionReveal>
          ...
          {faqItems.map((faq, i) => (
            <SectionReveal key={i} delay={i * 0.04}>
              <div
                ...
                style={{
                  borderColor: openIndex === i ? "hsl(32 100% 55% / 0.3)" : "hsl(var(--border) / 0.6)",
                  background: openIndex === i ? "hsl(32 100% 55% / 0.03)" : "hsl(var(--panel))",
                }}
        ...
        <SectionReveal className="mt-12">
          ...
          >
            ...
            <p className="text-xs text-muted-foreground mb-4">
              {lang === "en" ? "Reach out to the NCC team directly." : "Hubungi tim NCC secara langsung."}
            </p>
            <a
              href="/contact"
